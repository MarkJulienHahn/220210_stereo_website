  ...
  return (
    <main>
      ...
      <AnimatePresence exitBeforeEnter>
        ...
        <div className="legalsBackground">
          <motion.div
            location={location}
          ...
          >
            <div className="legalsOuter">
              <div className="legalsWrapper">
                ...
                <p>
                  The content of this website is protected by copyright. All
                ...
                <p>
                  {" "}
                  STEREO TYPEFACES®, GIALLO® and PROTEST GROTESK® are registered
                  Trademarks at the{" "}
                  <a
                  ...
                  and the{" "}
                  <a
                    href="https://www.dpma.de/english/index.html"
                    target="_blank"
                    rel="noreferrer"
                  >
              ...
              <div className="legalsWrapper">
                ...
                <p>
                  ...
                  for the management of the Stereo Typefaces Hahn und Obst GbR.
                  The use of the Internet pages of the Stereo Typefaces Hahn und
                  Obst GbR is possible without any indication of personal data;
                  however, if a data subject wants to use special enterprise
                  services via our website, processing of personal data could
                ...
                <p>
                  ...
                  protection regulations applicable to the Stereo Typefaces Hahn
                  und Obst GbR. By means of this data protection declaration,
                ...
                <p>
                  As the controller, the Stereo Typefaces Hahn und Obst GbR has
                ...
                <h2>1. Definitions</h2>
                <p>
                  The data protection declaration of the Stereo Typefaces Hahn
                  und Obst GbR is based on the terms used by the European
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      the specific criteria for its nomination may be provided
                ...
                <p>Stereo Typefaces Hahn und Obst GbR</p>
                <p>Groninger Straße 48</p>
                <p>13347 Berlin</p>
                <p>Germany</p>
                <p>Phone: +49 152 03 56 93 05</p>
                <p>Email: info@stereotypefaces.com</p>
                <p>Website: www.stereotypefaces.com</p>
                <h2>3. Cookies</h2>
                <p>
                  The Internet pages of the Stereo Typefaces Hahn und Obst GbR
                ...
                <p>
                  ...
                  through which Internet pages and servers can be assigned to
                  the specific Internet browser in which the cookie was stored.
                  This allows visited Internet sites and servers to
                  differentiate the individual browser of the dats subject from
                  other Internet browsers that contain other cookies. A specific
                  Internet browser can be recognized and identified using the
                  unique cookie ID.
                </p>
                <p>
                  Through the use of cookies, the Stereo Typefaces Hahn und Obst
                  GbR can provide the users of this website with more
                  user-friendly services that would not be possible without the
                  cookie setting.
                </p>
                <p>
                  By means of a cookie, the information and offers on our
                  website can be optimized with the user in mind. Cookies allow
                  us, as previously mentioned, to recognize our website users.
                  The purpose of this recognition is to make it easier for users
                ...
                <p>
                  ...
                  setting of the Internet browser used, and may thus permanently
                  deny the setting of cookies. Furthermore, already set cookies
                  may be deleted at any time via an Internet browser or other
                  software programs. This is possible in all popular Internet
                ...
                <p>
                  The website of the Stereo Typefaces Hahn und Obst GbR collects
                  a series of general data and information when a data subject
                  or automated system calls up the website. This general data
                  and information are stored in the server log files. Collected
                  may be (1) the browser types and versions used, (2) the
                  operating system used by the accessing system, (3) the website
                ...
                <p>
                  When using these general data and information, the Stereo
                  Typefaces Hahn und Obst GbR does not draw any conclusions
                  about the data subject. Rather, this information is needed to
                  (1) deliver the content of our website correctly, (2) optimize
                  the content of our website as well as its advertisement, (3)
                  ...
                  Stereo Typefaces Hahn und Obst GbR analyzes anonymously
                ...
                <p>
                  ...
                  website of the controller with the indication of personal
                  data. Which personal data are transmitted to the controller is
                  determined by the respective input mask used for the
                  registration. The personal data entered by the data subject
                  are collected and stored exclusively for internal use by the
                  controller, and for his own purposes. The controller may
                  request transfer to one or more processors (e.g. a parcel
                  service) that also uses personal data for an internal purpose
                ...
                <p>
                  ...
                  used by the data subject—date, and time of the registration
                  are also stored. The storage of this data takes place against
                  the background that this is the only way to prevent the misuse
                  of our services, and, if necessary, to make it possible to
                ...
                <p>
                  ...
                  may only be offered to registered users due to the nature of
                  the matter in question. Registered persons are free to change
                  the personal data specified during the registration at any
                  time, or to have them completely deleted from the data stock
                  of the controller.
                </p>
                <p>
                  ...
                  controller shall correct or erase personal data at the request
                  or indication of the data subject, insofar as there are no
                  statutory storage obligations. The entirety of the
                ...
                <p>
                  During the registration for the newsletter, we also store the
                  IP address of the computer system assigned by the Internet
                  service provider (ISP) and used by the data subject at the
                  time of the registration, as well as the date and time of the
                  registration. The collection of this data is necessary in
                  order to understand the (possible) misuse of the e-mail
                  address of a data subject at a later date, and it therefore
                ...
                <p>
                  ...
                  newsletter service or a registration in question, as this
                  could be the case in the event of modifications to the
                  newsletter offer, or in the event of a change in technical
                  circumstances. There will be no transfer of personal data
                  ...
                  newsletter at any time directly on the website of the
                  controller, or to communicate this to the controller in a
                  different way.
                </p>
                <h2>7. Newsletter-Tracking</h2>
                <p>
                  The newsletter of the Stereo Typefaces Hahn und Obst GbR
                  contains so-called tracking pixels. A tracking pixel is a
                  miniature graphic embedded in such e-mails, which are sent in
                  HTML format to enable log file recording and analysis. This
                  allows a statistical analysis of the success or failure of
                  online marketing campaigns. Based on the embedded tracking
                  pixel, the Stereo Typefaces Hahn und Obst GbR may see if and
                  when an e-mail was opened by a data subject, and which links
                  in the e-mail were called up by data subjects.
                </p>
                <p>
                  Such personal data collected in the tracking pixels contained
                  in the newsletters are stored and analyzed by the controller
                  in order to optimize the shipping of the newsletter, as well
                  as to adapt the content of future newsletters even better to
                  the interests of the data subject. These personal data will
                  not be passed on to third parties. Data subjects are at any
                  time entitled to revoke the respective separate declaration of
                  consent issued by means of the double-opt-in procedure. After
                  a revocation, these personal data will be deleted by the
                  controller. The Stereo Typefaces Hahn und Obst GbR
                ...
                <ul>
                  <li>
                    ...
                    <p>
                      ...
                      him or her are being processed. If a data subject wishes
                      to avail himself of this right of confirmation, he or she
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      stored by the Stereo Typefaces Hahn und Obst GbR, he or
                      she may, at any time, contact any employee of the
                      controller. An employee of Stereo Typefaces Hahn und Obst
                      GbR shall promptly ensure that the erasure request is
                    ...
                    <p>
                      ...
                      data subject has requested erasure by such controllers of
                      any links to, or copy or replication of, those personal
                      data, as far as processing is not required. An employees
                      of the Stereo Typefaces Hahn und Obst GbR will arrange the
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      processing of personal data stored by the Stereo Typefaces
                      Hahn und Obst GbR, he or she may at any time contact any
                      employee of the controller. The employee of the Stereo
                      Typefaces Hahn und Obst GbR will arrange the restriction
                      of the processing.{" "}
                    </p>
                  </li>
                  <li>
                    ...
                    <p>
                      ...
                      subject may at any time contact any employee of the Stereo
                      Typefaces Hahn und Obst GbR.
                    </p>
                  </li>
                  <li>
                    ...
                    <p>
                      The Stereo Typefaces Hahn und Obst GbR shall no longer
                    ...
                    <p>
                      If the Stereo Typefaces Hahn und Obst GbR processes
                      ...
                      objects to the Stereo Typefaces Hahn und Obst GbR to the
                      processing for direct marketing purposes, the Stereo
                      Typefaces Hahn und Obst GbR will no longer process the
                    ...
                    <p>
                      ...
                      Stereo Typefaces Hahn und Obst GbR for scientific or
                    ...
                    <p>
                      ...
                      may contact any employee of the Stereo Typefaces Hahn und
                      Obst GbR. In addition, the data subject is free in the
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      may, at any time, contact any employee of the Stereo
                      Typefaces Hahn und Obst GbR.
                    </p>
                  </li>
                  <li>
                    ...
                    <p>
                      ...
                      any employee of the Stereo Typefaces Hahn und Obst GbR.
                    </p>
                  </li>
                </ul>
                <h2>
                ...
                <p>
                  ...
                  <a href="https://willing-able.com/">LegalTech</a> at Willing &
                  Able that also developed the system for{" "}
                  <a href="https://abletotrack.com/">time tracking app</a>. The
                  legal texts contained in our privacy policy generator have
